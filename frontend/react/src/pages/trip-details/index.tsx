                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-2.5">
                            ...
                            <p className="text-zinc-500 text-small">Nenhum atividade cadastrada nessa data</p>
                        </div>
                        <div className="space-y-2.5">
                            <div className="flex gap-2 items-baseline">
                            ...
                            <div className="space-y-2.5">
                                <div className="px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex itmes-center gap-3">
                ...
                <div className="w-80 space-y-6">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <a href="#" className="block text-xs text-zinc-400 truncate hover:text-zinc-200">
                                        www.airbnb.com.br/oikdjakdjdjasdjasdjsaldjaslkçdjsalkdjaskljdalskdjaldjlk
                                    </a>
                                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100">Dra.Rita</span>
                                    <span  className="block text-sm text-zinc-400 truncate ">
                                        rita@gmail.com
                                    </span>
                                </div>
