          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button>
                  <X className="size-5 text-zinc-400 hover:text-zinc-50" onClick={props.closeGuestsModal} />
                </button>
              </div>
              ...
              {props.emailsToInvite.map(email => {
                return (
                  <div key={email} className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                    ...
                    <button type="button">
                      <X onClick={() => props.removeEmailFromInvites(email)} className="size-4 text-zinc-400 hover:text-zinc-50" />
                    </button>
                  </div>
                  )
                }
